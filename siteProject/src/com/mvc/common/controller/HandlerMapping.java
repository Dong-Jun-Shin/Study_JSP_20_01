...
import com.mvc.member.controller.MemberIdCheckController;
import com.mvc.member.controller.MemberLoginController;
import com.mvc.member.controller.MemberPwdCheckController;
...
public class HandlerMapping {
	...
	public HandlerMapping() {
		...
		/* 회원관리 */
		mappings.put("/member/myPage.do", new MemberLoginController());
		mappings.put("/member/memberIdCheck.do", new MemberIdCheckController());
		mappings.put("/member/memberPwdCheck.do", new MemberPwdCheckController());
